...
var wasmImports = {
  ...
  Mh: ___syscall_accept4,
  Lh: ___syscall_bind,
  Kh: ___syscall_connect,
  Jh: ___syscall_dup3,
  g: ___syscall_fcntl64,
  Ih: ___syscall_getpeername,
  Hh: ___syscall_getsockname,
  _: ___syscall_getsockopt,
  Gh: ___syscall_ioctl,
  Fh: ___syscall_listen,
  Eh: ___syscall_mkdirat,
  Z: ___syscall_openat,
  Dh: ___syscall_poll,
  Ch: ___syscall_readlinkat,
  Bh: ___syscall_recvfrom,
  Ah: ___syscall_renameat,
  zh: ___syscall_rmdir,
  yh: ___syscall_sendto,
  ta: ___syscall_socket,
  xh: ___syscall_stat64,
  Y: ___syscall_unlinkat,
  uh: __emscripten_get_now_is_monotonic,
  th: __emscripten_lookup_name,
  sh: __emscripten_system,
  rh: __emscripten_throw_longjmp,
  za: __gmtime_js,
  ya: __localtime_js,
  xa: __mktime_js,
  qh: __tzset_js,
  E: _abort,
  ph: defos_set_cursor_locked_,
  ...
  sf: _emscripten_glFramebufferTextureLayer,
  rf: _emscripten_glFrontFace,
  qf: _emscripten_glGenBuffers,
  pf: _emscripten_glGenFramebuffers,
  of: _emscripten_glGenQueries,
  nf: _emscripten_glGenQueriesEXT,
  mf: _emscripten_glGenRenderbuffers,
  lf: _emscripten_glGenSamplers,
  kf: _emscripten_glGenTextures,
  jf: _emscripten_glGenTransformFeedbacks,
  hf: _emscripten_glGenVertexArrays,
  gf: _emscripten_glGenVertexArraysOES,
  ff: _emscripten_glGenerateMipmap,
  ef: _emscripten_glGetActiveAttrib,
  df: _emscripten_glGetActiveUniform,
  cf: _emscripten_glGetActiveUniformBlockName,
  bf: _emscripten_glGetActiveUniformBlockiv,
  af: _emscripten_glGetActiveUniformsiv,
  $e: _emscripten_glGetAttachedShaders,
  _e: _emscripten_glGetAttribLocation,
  Ze: _emscripten_glGetBooleanv,
  Ye: _emscripten_glGetBufferParameteri64v,
  ...
  Od: _emscripten_glPauseTransformFeedback,
  Nd: _emscripten_glPixelStorei,
  Md: _emscripten_glPolygonOffset,
  Ld: _emscripten_glProgramBinary,
  Kd: _emscripten_glProgramParameteri,
  Jd: _emscripten_glQueryCounterEXT,
  Id: _emscripten_glReadBuffer,
  Hd: _emscripten_glReadPixels,
  Gd: _emscripten_glReleaseShaderCompiler,
  Fd: _emscripten_glRenderbufferStorage,
  Ed: _emscripten_glRenderbufferStorageMultisample,
  Dd: _emscripten_glResumeTransformFeedback,
  Cd: _emscripten_glSampleCoverage,
  Bd: _emscripten_glSamplerParameterf,
  Ad: _emscripten_glSamplerParameterfv,
  zd: _emscripten_glSamplerParameteri,
  yd: _emscripten_glSamplerParameteriv,
  xd: _emscripten_glScissor,
  ...
  id: _emscripten_glTexStorage2D,
  hd: _emscripten_glTexStorage3D,
  gd: _emscripten_glTexSubImage2D,
  fd: _emscripten_glTexSubImage3D,
  ed: _emscripten_glTransformFeedbackVaryings,
  dd: _emscripten_glUniform1f,
  cd: _emscripten_glUniform1fv,
  bd: _emscripten_glUniform1i,
  ad: _emscripten_glUniform1iv,
  $c: _emscripten_glUniform1ui,
  _c: _emscripten_glUniform1uiv,
  Zc: _emscripten_glUniform2f,
  Yc: _emscripten_glUniform2fv,
  Xc: _emscripten_glUniform2i,
  Wc: _emscripten_glUniform2iv,
  Vc: _emscripten_glUniform2ui,
  Uc: _emscripten_glUniform2uiv,
  Tc: _emscripten_glUniform3f,
  Sc: _emscripten_glUniform3fv,
  Rc: _emscripten_glUniform3i,
  Qc: _emscripten_glUniform3iv,
  Pc: _emscripten_glUniform3ui,
  Oc: _emscripten_glUniform3uiv,
  ...
  Fc: _emscripten_glUniformMatrix2x3fv,
  Ec: _emscripten_glUniformMatrix2x4fv,
  Dc: _emscripten_glUniformMatrix3fv,
  Cc: _emscripten_glUniformMatrix3x2fv,
  Bc: _emscripten_glUniformMatrix3x4fv,
  Ac: _emscripten_glUniformMatrix4fv,
  zc: _emscripten_glUniformMatrix4x2fv,
  yc: _emscripten_glUniformMatrix4x3fv,
  xc: _emscripten_glUseProgram,
  wc: _emscripten_glValidateProgram,
  vc: _emscripten_glVertexAttrib1f,
  uc: _emscripten_glVertexAttrib1fv,
  tc: _emscripten_glVertexAttrib2f,
  sc: _emscripten_glVertexAttrib2fv,
  rc: _emscripten_glVertexAttrib3f,
  qc: _emscripten_glVertexAttrib3fv,
  pc: _emscripten_glVertexAttrib4f,
  oc: _emscripten_glVertexAttrib4fv,
  nc: _emscripten_glVertexAttribDivisor,
  mc: _emscripten_glVertexAttribDivisorANGLE,
  lc: _emscripten_glVertexAttribDivisorARB,
  kc: _emscripten_glVertexAttribDivisorEXT,
  ...
  ac: _emscripten_memcpy_js,
  $b: _emscripten_pause_main_loop,
...
var _defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = function (a0) {
  return (_defos_emit_event_from_js = Module["_defos_emit_event_from_js"] = wasmExports["Uh"])(a0);
};
...
var ___start_em_js = Module["___start_em_js"] = 270785;
var ___stop_em_js = Module["___stop_em_js"] = 271180;
